	...
	struct TerrainMeta
	{
		public:
			/*! @brief Compares two TerrainMeta instances for equivalent metadata.
				...
				@version 0.12.43
			*/
			ATTR_NODISCARD constexpr bool operator==(const TerrainMeta &other) const = default;
			...
			/*! @brief The terrains this one interacts with and the corresponding actions. */
			std::vector<Interaction<TerrainID>> mTerrainInteractions{};

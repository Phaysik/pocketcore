...
TEST_INCLUDE_FOLDER = testInclude
...
GENHTML_FLAGS = --dark-mode -o ${GENHTML_OUTPUT_FOLDER}
...
genhtml: lcov
	...
	genhtml ${OUTPUT_FOLDER_LCOV}/${OUTPUT_FILE_LCOV} ${BRANCH_COVERAGE} ${LCOV_EXCLUDE_ASSERT} ${GENHTML_FLAGS}

...
Pokemon makePokemon(const unsigned short level,
                    const unsigned short attack,
                    const unsigned short defense,
                    const unsigned short specialAttack,
                    const unsigned short specialDefense)
{
    return Pokemon{"UnitMon", attack, defense, 100U, 80U, specialAttack, specialDefense, level, NO_ABILITY_ID, NO_ITEM_ID, {NO_TYPE_ID, NO_TYPE_ID}};
}
...
SCENARIO("BaseDamageHandler")
{
    ...
    GIVEN("a physical attack with valid user and target stats")
    {
        ...
        userSlot.mStatStages = StatStages{.mAttack = 2, .mDefense = 0, .mSpAttack = 0, .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};
        userSlot.mDamageFormulaModifiers = DamageFormulaModifiers{.mHealthModifier = 1.0F,
        ...
        targetSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 1, .mSpAttack = 0, .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};
        targetSlot.mDamageFormulaModifiers = DamageFormulaModifiers{.mHealthModifier = 1.0F,
    ...
    GIVEN("a critical special attack with unfavorable user and favorable target stages")
    {
        ...
        BattleSlot userSlot{};
        userSlot.mPokemon = &userPokemon;
        userSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = 1, .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};
        userSlot.mDamageFormulaModifiers = DamageFormulaModifiers{.mHealthModifier = 1.0F,
                                                                  .mAttackModifier = 1.0F,
                                                                  .mDefenseModifier = 1.0F,
                                                                  .mSpecialAttackModifier = 1.0F,
        ...
        BattleSlot targetSlot{};
        targetSlot.mPokemon = &targetPokemon;
        targetSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = 0, .mSpDefense = 6, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};
        targetSlot.mDamageFormulaModifiers = DamageFormulaModifiers{.mHealthModifier = 1.0F,
                                                                    .mAttackModifier = 1.0F,
                                                                    .mDefenseModifier = 1.0F,
                                                                    .mSpecialAttackModifier = 1.0F,
    ...
    GIVEN("critical damage with negative stages")
    {
        ...
        BattleSlot userSlot{};
        userSlot.mPokemon = &userPokemon;
        userSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = static_cast<signed char>(-1), .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};

        BattleSlot targetSlot{};
        targetSlot.mPokemon = &targetPokemon;
        targetSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = 0, .mSpDefense = static_cast<signed char>(-1), .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};
    ...
    GIVEN("non-critical special damage with a negative user special attack stage")
    {
        ...
        BattleSlot targetSlot{};
        targetSlot.mPokemon = &targetPokemon;
        targetSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = 0, .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 0};

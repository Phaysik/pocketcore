...
SCENARIO("AccuracyCheckHandler")
{
    ...
    GIVEN("perfect move accuracy and neutral stages")
    {
        ...
        userSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = 0, .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 6, .mEvasion = 0};

        BattleSlot targetSlot{};
        targetSlot.mPokemon = &targetPokemon;
        targetSlot.mStatStages = StatStages{.mAttack = 0, .mDefense = 0, .mSpAttack = 0, .mSpDefense = 0, .mSpeed = 0, .mAccuracy = 0, .mEvasion = 6};
    ...
    GIVEN("zero move accuracy")
    {
        ...
        battleState.mSideA.push_back(BattleSlot{.mPokemon = &userPokemon,
                                                 .mStatStages = StatStages{.mAttack = 0,
                                                                           .mDefense = 0,
                                                                           .mSpAttack = 0,
                                                                           .mSpDefense = 0,
                                                                           .mSpeed = 0,

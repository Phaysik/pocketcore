/*! @file flinchHandler.cpp
	@brief Contains the flinch effect handler implementation
	@date 08/28/2026
	@since 0.10.0
	@version 0.12.9
...
namespace PocketCore::Effect
{
	...
	void FlinchHandler::apply(ATTR_MAYBE_UNUSED BattleState &state, ATTR_MAYBE_UNUSED EffectContext &context,
